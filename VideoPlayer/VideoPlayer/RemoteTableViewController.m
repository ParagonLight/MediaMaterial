...
@interface RemoteTableViewController (){
    NSInteger num;
}
...
- (void)viewDidLoad
{
    ...
    ParagonAppDelegate *appDelegate = [[UIApplication sharedApplication] delegate];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self playMovieRemote:cell.detailTextLabel.text];
    // Configure the cell...
}

#pragma mark - media control
-(IBAction)playMovieRemote:(NSString*)urlString{
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"MovieData" inManagedObjectContext:self.managedObjectContext];
