...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    NSMutableDictionary *movie = [_data objectAtIndex:indexPath.row];
    cell.textLabel.text = [movie objectForKey:@"title"];
    cell.detailTextLabel.text = [movie objectForKey:@"url"];
    return cell;
}
...
-(void)addToTable:(NSString *)title URL:(NSString *)url{
    ...
    [content setValue:url forKey:@"url"];
    [_data addObject:content];
